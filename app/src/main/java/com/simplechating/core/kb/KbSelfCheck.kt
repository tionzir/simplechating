package com.simplechating.core.kb
...
object KbSelfCheck {
    ...
    fun run(context: Context): String {
        ...
        try {
            ...
            val ctx1 = ContextBuilder.build(context, snapshot, "com.simplechating", prefs)
            ...
            store.appendLog(contactId, listOf(
                LogEntry("other", OLD_LINE, System.currentTimeMillis() - 86_400_000L, "com.simplechating")),
                screenBatch = false)
            val ctx2 = ContextBuilder.build(context, snapshot, "com.simplechating", prefs)
            ...
            if (ContextBuilder.build(context, snapshot, "com.simplechating", prefs).history.isNotEmpty())
